                                                    ...
                                                    @foreach($puntos as $indexpunto => $punto)
                                                        <tr>
                                                            <td class="tdline p-3">
                                                                ...
                                                                {{str_replace("SARA","",$indexsuc)}} - {{$indexpunto}}
                                                            </td>
                                                            @foreach($clases as $index => $data)
                                                                @php
                                                                ...
                                                                <td class="tdline p-3">
                                                                    @if($monto != 0)
                                                                        <a href="javascript:;" class="text-decoration-none text-primary text-end "
                                                                           onclick="$('#asd{{$modalId}}').modal('show')">
                                                                            <i class="bi bi-link me-1"></i>
                                                                              {{ number_format($monto, 2, ',', '.') }}
                                                                        </a>

                                                                        <!-- Modal generado aquí mismo -->
                                                                        <div class="modal fade" id="asd{{$modalId}}" tabindex="-1">
                                                                            <div class="modal-dialog modal-xl modal-dialog-scrollable">
                                                                                <div class="modal-content">
                                                                                    <div class="modal-header">
                                                                                        <h5 class="modal-title text-white">
                                                                                            <i class="bi bi-receipt me-2"></i>
                                                                                            Detalle de Transacciones en Bolívares
                                                                                        </h5>
                            ...
                            <div class="card mt-5">
                                <div class="card-header bg-light">
                                    <h5 class="mb-0">
                                        ...
                                        Distribución por Instrumento (Bs.)
                                    </h5>
                                </div>
                                <div class="card-body">
                                    @php
